    ...
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-14 lg:gap-16 items-center">
          ...
          {/* Left: Actual Work Image (48%) - Fully responsive, original ratio preserved with no overlays */}
          <div className="w-full lg:w-[48%] rounded-[24px] overflow-hidden shadow-3xs border border-slate-100/80 bg-slate-50 shrink-0">
            <Image
          ...
          <div className="w-full lg:w-[52%] flex flex-col justify-center py-1">
            ...
            <div className="hidden lg:block space-y-3 mb-8">
              ...
              <h2 className="text-[36px] xl:text-[40px] font-black text-slate-900 tracking-tight leading-[1.2] mt-2.5">
                창틀 누수는 보이는 틈만 막아서는 재발할 수 있습니다
              </h2>
              <p className="text-[14.5px] xl:text-[15px] text-slate-500 leading-relaxed max-w-xl mt-4">
                물이 보이는 위치와 실제 유입 지점은 다를 수 있습니다. 기존 실리콘 접착 상태, 샷시와 벽체 사이 틈, 외벽 크랙을 함께 확인해야 재누수 가능성을 줄일 수 있습니다.
              </p>
            </div>
            ...
            <div className="space-y-3">
              {/* Card 1 */}
              <div className="flex gap-4 py-[18px] px-[22px] bg-slate-50/50 border border-slate-200/40 rounded-2xl hover:bg-slate-50 hover:translate-x-0.5 hover:shadow-3xs transition-all duration-300">
                <div className="w-[44px] h-[44px] bg-teal-50 rounded-xl text-teal-600 shrink-0 flex items-center justify-center">
            ...
            {/* Slim Highlight Box */}
            <div className="mt-6 p-[22px] bg-teal-50/40 border border-teal-500/10 rounded-2xl">
              <p className="text-[14.5px] sm:text-[15.5px] font-bold text-slate-900 leading-[1.45]">
            ...
            <div className="mt-6 flex flex-col items-start gap-3 w-full">
              <Link
                href="#contact"
                className="px-10 py-5 w-full sm:w-auto text-center bg-teal-600 hover:bg-teal-700 text-white text-[16px] font-black rounded-2xl shadow-xs hover:shadow-sm transition-all"
              >
                우리 집 누수 원인 상담하기
              </Link>
              <div className="space-y-1.5 pl-1">
                ...
                <p className="text-[11.5px] text-teal-800/60 font-semibold">
