    ...
    <section className="relative min-h-[680px] lg:min-h-[760px] flex items-center py-12 lg:py-20 overflow-hidden bg-slate-950">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        {/* Responsive Dark Overlays to ensure maximum readability */}
        <div className="absolute inset-0 bg-slate-950/75 lg:bg-gradient-to-r lg:from-slate-950/45 lg:via-slate-950/65 lg:to-slate-950/80 z-10 pointer-events-none"></div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
        <div className="flex flex-col lg:flex-row justify-end w-full">
          ...
          {/* Glassmorphism Content Panel (Desktop Right 46%, max-width 540px) */}
          <div className="w-full lg:w-[46%] max-w-[540px] bg-white/95 backdrop-blur-md rounded-[32px] p-7 sm:p-10 lg:p-12 shadow-xl border border-white/20 space-y-6 shrink-0">
            ...
            <div className="space-y-3">
              ...
              <h2 className="text-2xl sm:text-[28px] lg:text-[30px] font-black text-slate-900 tracking-tight leading-[1.25]">
            ...
            {/* 3 Cause Cards (Compact Glass Cards) */}
            <div className="space-y-2.5">
              {/* Card 1 */}
              <div className="flex gap-3.5 p-4 bg-teal-50/10 border border-teal-500/5 rounded-2xl hover:bg-teal-50/20 transition-all duration-300">
            ...
            {/* Slim Highlight Box */}
            <div className="p-4.5 bg-teal-50/50 border border-teal-500/10 rounded-2xl">
