    ...
    >
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex items-center gap-3">
          <Link
            href="#contact"
            className="hidden sm:inline-flex items-center justify-center px-5 py-2.5 text-[13.5px] font-bold text-white bg-teal-600 hover:bg-teal-700 transition-all rounded-full shadow-sm hover:shadow-md"
          >
            실시간 진단 의뢰
          </Link>
          <Link
            href="tel:010-4667-5568" // 실제 상담용 가상 번호
